    ...
    case 61871084: {
      ...
      if (element) {
        ...
        if (loader.engine.document.rootNode[34]?.offsetParent != null) {
          let element2 = loader.engine.document.getElementById(97747666);
          if (element2.visible == true) {
            setTimeout(() => {
            element.dispatchEvent(new Event('change', { bubbles: true }));
            }, 200); // Small delay to allow the DOM to register change
          }
...
loader.engine.document.addEventListener('change', displayCodeSATP);
